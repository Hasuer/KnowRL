...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None, memory_limit_mb=None):
    ...
    if data_source == "openai/gsm8k":
        ...
        res = gsm8k.compute_score(solution_str, ground_truth)
                         ...
                         "Maxwell-Jia/AIME_2024", "BytedTsinghua-SIA/DAPO-Math-17k", 
                         "math-ai/aime25", "zwhe99/amc23", "EB/math24o", "foreverlasting1202/QuestA",
                         "nvidia/AceReason-Math", "HasuerYu/Math_KP_RL", "MathArena/hmmt_feb_2025", "MathArena/brumo_2025"]:
        # from . import math
    ...
    elif data_source in ["webqsp-train","webqsp-test", "webqsp_train", "cwq-train", "cwq-test"]:
        # webqsp数据
        from . import webqsp
        
        res = webqsp.compute_score_v2(solution_str, ground_truth)
    elif data_source in ["webqsp_train_prmapi", "webqsp_test_prmapi"]:
        from . import webqsp
        
        res = webqsp.compute_score_prm_api(solution_str, ground_truth)
    elif data_source in ["webqsp_train_grmapi", "webqsp_test_grmapi"]:
        from . import webqsp
        
        res = webqsp.compute_score_genrm_api(solution_str, ground_truth)
